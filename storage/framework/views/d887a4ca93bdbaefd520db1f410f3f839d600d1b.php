            ...
            <div class="card">
                ...
                <div class="card-body collapse show" id="detail_sampel_pi">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="rpd_filling_detail_id" id="rpd_filling_detail_id" value="<?php echo e($rpd_filling_detail->encrypt_id); ?>">
                        <input type="hidden" name="filling_machine_id" id="filling_machine_id" value="<?php echo e($rpd_filling_detail->encrypt_id); ?>">
                        <input type="text" name="filling_sampel_code" id="filling_sampel_code" class="form-control" value="<?php echo e($rpd_filling_detail->filling_sampel_code->filling_sampel_code.' - '.$rpd_filling_detail->filling_sampel_code->filling_sampel_event); ?>" readonly>
                        <input type="hidden" class="form-control datetimepicker-input" name="filling_date_old" id="filling_date_old"  value="<?php echo e($rpd_filling_detail->filling_date); ?>" />
                        <input type="hidden" class="form-control datetimepicker-input" name="filling_time_old" id="filling_time_old"  value="<?php echo e($rpd_filling_detail->filling_time); ?>" autocomplete="off" required/>
                    </div>
                    <div class="form-group">
                        <label for="product_name">Nama Produk</label>
                        <input type="text" name="product_name" id="product_name" class="form-control" value="<?php echo e($rpd_filling_detail->product->product_name); ?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="filling_machine">Mesin Filling</label>
                        <input type="text" name="filling_machine" id="filling_machine" class="form-control" value="<?php echo e($rpd_filling_detail->filling_machine->filling_machine_code); ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date mb-2 datepickernya" data-target-input="nearest">
                            ...
                            <input type="text" class="form-control datetimepicker-input" name="filling_date" id="filling_date" data-target=".datepickernya" value="<?php echo e($rpd_filling_detail->filling_date); ?>" data-target=".datepickernya" data-toggle="datetimepicker"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group date mb-2 timepickernya" data-target-input="nearest">
                            ...
                            <input type="text" class="form-control datetimepicker-input" name="filling_time" id="filling_time" data-target=".timepickernya" data-toggle="datetimepicker" value="<?php echo e($rpd_filling_detail->filling_time); ?>"/ autocomplete="off" required/>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body collapse show" id="parameter_analisa_pi">
                    <div class="form-group">
                        ...
                        <small id="overlap_help_text" class="form-text text-muted">
                            Batas overlap <?php if($rpd_filling_detail->filling_machine->filling_machine_code == 'TPA A'): ?> Min. 4.5 Batas Max. 6.0 <?php else: ?> Batas Min. 3.5 Batas Max. 4.5 <?php endif; ?>
...
<script>
    ...
    function submitForm()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('rollie/rpd-filling/analisa-filling-sampel')); ?>",
            type:'POST',
            beforeSend:function()
            {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/rollie/rpd_filling/_form_analisa_sampel_pi.blade.php ENDPATH**/ ?>