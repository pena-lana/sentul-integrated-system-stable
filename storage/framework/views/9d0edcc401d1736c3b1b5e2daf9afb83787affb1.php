...
<?php $__env->startSection('custom-plugin'); ?>
    <script>
        ...
        var table = $('#filling_machine_table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(url('master-apps/manage-filling-machine/get-data')); ?>",
        ...
        function changeStatusFillingMachine(data)
        {
            ...
            $.ajax({
                url:"<?php echo e(url('master-apps/manage-filling-machine/change-status-filling-machine')); ?>",
                type:'POST',
                beforeSend:function()
                {
        ...
        {
            $.ajax({
                url:"<?php echo e(url('master-apps/manage-filling-machine/add-new-filling-machine-modal')); ?>",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function editFillingMachine(data)
        {
            ...
            filling_machine_id      = data[3];
            $.ajax({
                url:"<?php echo e(url('master-apps/manage-filling-machine/edit-filling-machine')); ?>",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/master_app/manage_filling_machine/index.blade.php ENDPATH**/ ?>