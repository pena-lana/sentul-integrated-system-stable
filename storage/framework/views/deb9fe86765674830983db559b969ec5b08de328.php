<?php $__env->startSection('content'); ?>
    ...
    <select name="brand_select" id="brand_select" class="hidden">
       <?php $__currentLoopData = $subbrands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subbrand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <option value="<?php echo e($subbrand->subbrand_name); ?>"><?php echo e($subbrand->subbrand_name); ?></option>
    ...
    <select name="product_type_select" id="product_type_select" class="hidden">
        <?php $__currentLoopData = $product_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($product_type->product_type); ?>"><?php echo e($product_type->product_type); ?></option>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     </select>
...
<?php $__env->startSection('custom-plugin'); ?>
    <script>
        ...
        var table = $('#product-table').DataTable({
            ...
            // "scrollX": true,
            ajax: {
                url: "<?php echo e(url('master-apps/manage-product/get-data')); ?>",
        ...
        {
            $.ajax({
                url:"<?php echo e(url('master-apps/manage-product/add-new-product-modal')); ?>",
                type:'POST',
                beforeSend:function()
                {
        ...
        function editProduct(data)
        {
            ...
            product_id      = data[2];
            $.ajax({
                url:"<?php echo e(url('master-apps/manage-product/edit-product-modal')); ?>",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/master_app/manage_product/index.blade.php ENDPATH**/ ?>