<div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body collapse show" id="detail_sampel_pi">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="params" id="params" value="<?php echo e($rpd_filling_detail->params); ?>">
                        <input type="text" name="filling_sampel_code" id="filling_sampel_code" class="form-control" value="<?php echo e($rpd_filling_detail->filling_sampel_code->filling_sampel_code.' - '.$rpd_filling_detail->filling_sampel_code->filling_sampel_event.' (Event)'); ?>" readonly>
                        <input type="hidden" class="form-control " name="filling_date_old" id="filling_date_old" value="<?php echo e($rpd_filling_detail->filling_date); ?>" />
                        <input type="hidden" class="form-control " name="filling_time_old" id="filling_time_old" value="<?php echo e($rpd_filling_detail->filling_time); ?>" />
                    </div>
    ...
    <script>
        ...
        var params  = "<?php echo e($rpd_filling_detail->params); ?>";
        ...
        $(document).ready(function()
        {
            ...
            form.validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('rollie/rpd-filling/analisa-filling-sampel-event')); ?>",
                        type:'POST',
                        beforeSend:function()
                        {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/rollie/rpd_filling/_form_analisa_sampel_pi_at_event.blade.php ENDPATH**/ ?>