    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <form method="post" id="add-filling-machine-form">
            <div class="form-group">
                ...
                <input type="text" name="filling_machine_group_name" id="filling_machine_group_name" class="form-control" placeholder="ex. TBA / A3" value="<?php echo e($filling_machine_group_head->filling_machine_group_name); ?>" required>
            </div>
        </form>
...
<script>
    function updateFillingMachineGroupHead()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-filling-machine-group/update-filling-machine-group-head')); ?>",
            type:'POST',
            beforeSend:function()
            {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/master_app/manage_filling_machine_group/_edit_filling_machine_group_head.blade.php ENDPATH**/ ?>