...
<?php $__env->startSection('custom-plugin'); ?>
    <script>
        ...
        var table = $('#production-schedule-table').DataTable({
            ...
            // "scrollX": true,
            ajax: {
                url: "<?php echo e(url('rollie/production-schedule/get-data')); ?>",
    ...
    <script>
        ...
        function updateProductionSchedule(data)
        {
            ...
            wo_id               = data[2];
            $.ajax({
                url:"<?php echo e(url('rollie/production-schedule/update-schedule-modal')); ?>",
                type:'POST',
                beforeSend:function()
                {
                ...
                if(result.isDenied)
                {
                    Swal.fire({
                        ...
                        if (result.isConfirmed)
                        {
                            ...
                            {
                                $.ajax({
                                    url:"<?php echo e(url('rollie/production-schedule/cancel-production-schedule')); ?>",
                                    type:'POST',
                                    beforeSend:function()
                                    {
                                        $('.loading-bar').removeClass('hidden');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/rollie/production_schedule/index.blade.php ENDPATH**/ ?>