                ...
                <div class="form-group">
                    ...
                    <select name="wo_number_id" id="wo_number_id" class="select selectcustom2 form-control" required>
                        <?php
                            $batch_ke =1;
                        ?>
                        <?php $__currentLoopData = $rpd_filling_head->woNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wo_number): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($wo_number->encrypt_id); ?>" <?php if($wo_number->wo_number === $last_wo_number->wo_number): ?> selected <?php endif; ?>> Batch <?php echo e($batch_ke); ?>- <?php echo e($wo_number->wo_number); ?></option>
                    ...
                    <input type="hidden" value="<?php echo e($rpd_filling_head->encrypt_id); ?>" name="rpd_filling_head_id" id="rpd_filling_head_id">
                </div>
                <div class="form-group">
                    ...
                    <select name="filling_machine_id" id="filling_machine_id" class="form-control select2" onchange="getFillingSampelCode(this)" required>
                        ...
                        <?php $__currentLoopData = $last_wo_number->filling_machine_group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filling_machine_group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($filling_machine_group->filling_machine->encrypt_id); ?>"><?php echo e($filling_machine_group->filling_machine->filling_machine_code); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="form-group">
    ...
    <script>
        ...
        $(document).ready(function()
        {
            ...
            form.validate({
                ...
                submitHandler: function(form) {
                    ...
                    $.ajax({
                        url:"<?php echo e(url('rollie/rpd-filling/add-filling-sampel-code')); ?>",
                        type:'POST',
                        beforeSend:function()
                        {
        ...
        function getFillingSampelCode(data)
        {
            ...
            $.ajax({
                url:"<?php echo e(url('rollie/rpd-filling/get-filling-sampel-code')); ?>",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function checkFillingSampelCode(data)
        {
            ...
            $.ajax({
                url:"<?php echo e(url('rollie/rpd-filling/check-filling-sampel-code')); ?>",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/rollie/rpd_filling/_form-add-sampel.blade.php ENDPATH**/ ?>