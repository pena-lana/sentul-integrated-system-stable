...
<script>
     var table = $('#user-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(url('master-apps/manage-user/get-data')); ?>",
    ...
    function editUser(data)
    {
        ...
        user_id     = data[2];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user/edit-user')); ?>",
            type:'POST',
            beforeSend:function()
            {
    ...
    function updateUser()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user/update-user')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
    ...
    function changeStatus(data)
    {
        ...
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user/change-status-user')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
    ...
    function verifyUser(data)
    {
        ...
        user_id     = data[2];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user/verify-user')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
    ...
    function resetPassword(data)
    {
        ...
        user_id     = data[2];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user/reset-password')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/master_app/manage_user/index.blade.php ENDPATH**/ ?>