...
<html lang="en">
    <head>
        ...
        <title>Sisy - <?php echo e(Session::get('application')); ?></title>
        <link rel="stylesheet" href="<?php echo e(asset('css/admin-lte.css')); ?>" media="all" >
    ...
    <body class="sidebar-mini sidebar-collapse" style="height: auto;">
        <div id="loading-bar-overlay"  class="loading-bar hidden">
			<div id="text">
				<img src="<?php echo e(asset('images/icon/loading.gif')); ?>"  width="300px" >
			</div>
		</div>
        <div class="wrapper">
            <!-- Navbar -->
            ...
            <aside class="main-sidebar sidebar-dark-primary elevation-4">
                ...
                <a href="javascript:void(0)" class="brand-link">
                    <img src="<?php echo e(asset('images/logo/logo-kecil.png')); ?>" alt="sisy-logo" class="brand-image img-responsive" style="opacity: 0.8;max-height: 44px;
                    margin-left: 0px;" />
                    <span class="brand-text font-weight-light"> <?php echo e(Session::get('application')); ?> </span>
                </a>
                ...
                <div class="sidebar">
                    ...
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        <div class="image">
                            <img src="<?php echo e(asset('images/icon/user.png')); ?>" class="img-circle elevation-2" alt="User Image" />
                        </div>
                        <div class="info">
            ...
            <div class="content-wrapper" style="min-height: 654px;">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h4 class="m-0"><?php echo e(Session::get('menu_name')); ?></h4>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item">
                                        <a href="<?php echo e(route('credential_access.home-page')); ?>">Sisy</a>
                                    </li>
                                    <li class="breadcrumb-item active"><?php echo e(Session::get('application')); ?></li>
                                </ol>
                            </div>
                            <!-- /.col -->
                        </div>
        ...
        <?php echo $__env->yieldContent('pop-up-plugin'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/layouts/app.blade.php ENDPATH**/ ?>