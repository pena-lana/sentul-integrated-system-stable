    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <form id="add-batch-form">
            <div class="form-group">
                ...
                <input type="hidden" name="rpd_filling_head_id" id="rpd_filling_head_id" class="form-control" value="<?php echo e($rpd_filling_head_id); ?>">
...
<script>
    ...
    function getWoNumber(add_type,rpd_filling_head_id)
    {
        ...
        {
            $.ajax({
                url:"<?php echo e(url('rollie/rpd-filling/get-wo-number-batch')); ?>",
                type:'POST',
                beforeSend:function()
                {
    ...
    function addBatch()
    {
        ...
        $.ajax({
            url:"<?php echo e(url('rollie/rpd-filling/add-batch')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
            ...
            success: function(data)
            {
                switch (data.status)
                {
                    case '00':
                        $('.close').click();
                        url     = "<?php echo e(url('rollie/rpd-filling/form/')); ?>"+"/"+data.rpd_filling_head_id;
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/rollie/rpd_filling/_form-add-batch.blade.php ENDPATH**/ ?>