...
<script>
    function uploadMtolFile()
    {
        ...
        if (files.length)
        {
            ...
            $.ajax({
                url:"<?php echo e(url('rollie/production-schedule/upload-mtol')); ?>",
                type:'POST',
                beforeSend:function()
                {
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/rollie/production_schedule/_form_upload_mtol.blade.php ENDPATH**/ ?>