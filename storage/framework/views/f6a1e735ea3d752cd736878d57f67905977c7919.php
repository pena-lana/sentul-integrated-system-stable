...
<input type="hidden" name="application_id" id="application_id" value="<?php echo e($data['application_id']); ?>">
...
<script>
    var menu_permission_table = $('#menu-permission-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: "<?php echo e(url('master-apps/manage-user-permission/get-menu-permission')); ?>",
...
<script>
    function changeViewPermission(data)
    {
        ...
        user_id         = data[3];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user-permission/change-view-menu-permission')); ?>",
            type:'POST',
            beforeSend:function()
            {
    ...
    function changeCreatePermission(data)
    {
        ...
        user_id         = data[3];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user-permission/change-create-menu-permission')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
    ...
    function changeEditPermission(data)
    {
        ...
        user_id         = data[3];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user-permission/change-edit-menu-permission')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
    ...
    function changeDeletePermission(data)
    {
        ...
        user_id         = data[3];
        $.ajax({
            url:"<?php echo e(url('master-apps/manage-user-permission/change-delete-menu-permission')); ?>",
            type:'POST',
            beforeSend:function()
            {
                $('.loading-bar').removeClass('hidden');
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/sentul-integrated-system-stable/resources/views/master_app/user_permissions/_form.blade.php ENDPATH**/ ?>