...
@section('custom-plugin')
    <script>
        ...
        var table = $('#filling-machine-group-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('master-apps/manage-filling-machine-group/get-data') }}",
        ...
        $('#filling-machine-group-table tbody').on('click', 'td a.details-control', function () {
            ...
            else
            {
               ...
               /*  $('#table-data_'+filling_machine_group_head_id).DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ url('master-apps/manage-filling-machine-group/get-filling-machine-detail') }}",
                        dataSrc: function ( json )
                        {
                            if(json.status!=='01' && json.status!='02') //!=false or !=token expire or !=token not valid
                            {
        ...
        function changeStatusFillingMachineGroupHead(data)
        {
            ...
            $.ajax({
                url:"{{url('master-apps/manage-filling-machine-group/change-status-filling-machine-group')}}",
                type:'POST',
                beforeSend:function()
                {
        ...
        function editFillingMachineGroupHead(data)
        {
            ...
            filling_machine_group_head_id       = data[3];
            $.ajax({
                url:"{{url('master-apps/manage-filling-machine-group/edit-filling-machine-group-head')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function changeStatusFillingMachineGroupDetail(data)
        {
            ...
            $.ajax({
                url:"{{url('master-apps/manage-filling-machine-group/change-status-filling-machine-group-detail')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function createFillingMachineGroupHead(data)
        {
            ...
            filling_machine_group_head_id       = data[3];
            $.ajax({
                url:"{{url('master-apps/manage-filling-machine-group/add-filling-machine-group-detail-modal')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        {
            $.ajax({
                url:"{{url('master-apps/manage-filling-machine-group/add-new-filling-machine-group-modal')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
