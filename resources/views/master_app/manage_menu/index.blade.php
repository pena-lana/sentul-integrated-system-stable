...
@section('custom-plugin')
    <script>
        ...
        var table = $('#menu-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('master-apps/manage-menu/get-data') }}",
        ...
        {
            $.ajax({
                url:"{{url('master-apps/manage-menu/add-new-menu-modal')}}",
                type:'POST',
                beforeSend:function()
                {
        ...
        function editMenu(data)
        {
            ...
            menu_id      = data[2];
            $.ajax({
                url:"{{url('master-apps/manage-menu/edit-menu')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function changeStatusMenu(data)
        {
            ...
            $.ajax({
                url:"{{url('master-apps/manage-menu/change-status-menu')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
