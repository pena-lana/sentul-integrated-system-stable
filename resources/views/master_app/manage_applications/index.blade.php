...
@section('custom-plugin')
    <script>
        var table = $('#application-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "{{ url('master-apps/manage-application/get-data') }}",
    ...
    <script>
        function changeStatusApplication(data)
        {
            ...
            $.ajax({
                url:"{{url('master-apps/manage-application/change-status-application')}}",
                type:'POST',
                beforeSend:function()
                {
        ...
        function editApplication(data)
        {
            ...
            application_id      = data[2];
            $.ajax({
                url:"{{url('master-apps/manage-application/edit-application')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function updateApplication()
        {
            ...
            $.ajax({
                url:"{{url('master-apps/manage-application/update-application')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        {
            $.ajax({
                url:"{{url('master-apps/manage-application/add-new-application-modal')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
        ...
        function addApplication()
        {
            ...
            $.ajax({
                url:"{{url('master-apps/manage-application/add-new-application')}}",
                type:'POST',
                beforeSend:function()
                {
                    $('.loading-bar').removeClass('hidden');
